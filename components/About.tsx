...
<div className="flex flex-col gap-4">
  <p className="text-start text-muted-foreground lg:px-6">
    ...
    My work bridges design and engineering, ensuring digital products are both
  ...
  <p className="text-start text-muted-foreground lg:px-6">
    ...
    <span className="text-white">          
      <a
        ...
        href="https://techexecutivelabs.com/"
        target="blank"
        rel="noopener noreferrer"
      >
        Tech Executive Labs
      </a>
    </span>, where I focus on
    building high-performance web applications that balance usability and
    efficiency. I specialize in full-stack development, bringing together
    frontend interactivity and backend reliability to create scalable
    solutions. 
  </p>
  <p className="text-start text-muted-foreground lg:px-6">
